...
def update_mp_status(start):
    ...
    for doc in client.grammo.compras.aggregate(pipe):
        ...
        if statusmp:
            ...
            dict_pgto.update({'value_total': statusmp[0]["transaction_details"]["total_paid_amount"]})
            dict_pgto.update({'value_net': statusmp[0]["transaction_details"]["net_received_amount"]})
